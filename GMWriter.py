# GMWriter.py
# ---------------------------------------------
# May 7, 2013; Refactoring: Alex Safatli
#              Original Code: Kyle Nguyen
# ---------------------------------------------
# Refactoring of the Pairwise2GM application in
# order to function within the confines of the
# ABeRMuSA suite.
# ---------------------------------------------
# Take a whole set of pairwise alignments and 
# creates a final GM and landmarks file.
